...
const mission = (
  <div>
    ...
    <h3 className={styles.headline}>Representation in leadership matters.</h3>
    ...
    <figure className={styles.quote}>
      <blockquote>
        <span className={styles.quoteText}>
          The DNAs gave me so much, I want to be able to give back, and it is
          the best way I can give back, I feel, for Apple.
        </span>
      </blockquote>
    </figure>

    <h3 className={styles.headline}>Support for development at every level.</h3>
    <p>
      Opportunity starts with equitable access to career development programs
      and support. From new‑hire orientation to talent planning, we’re embedding
      programs, processes, and resources that support employees and help current
      leaders identify and develop future leaders equitably.
    </p>
  </div>
);
