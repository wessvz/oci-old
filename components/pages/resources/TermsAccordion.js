    ...
    <Accordion.Root type="single" collapsible>
      <Accordion.Item className={styles.AccordionItem} value="item-1">
        ...
        <AccordionContent className={styles.AccordionContent}>
          ...
          <List style="terms">
            <Item>1. OCI: the private limited company OCI BV.</Item>
            <Item>
        ...
        <AccordionContent className={styles.AccordionContent}>
          <List style="terms">
            <Item>
              ...
              <List style="default">
                <Item>Whether the correct goods have been delivered;</Item>
                <Item>
          ...
          <List style="terms">
            ...
            <Item>
              ...
              <List style="default">
                ...
                <Item>repairs by third parties, including the client;</Item>
                <Item>
      ...
      <Accordion.Item className={styles.AccordionItem} value="item-11">
        ...
        <AccordionContent className={styles.AccordionContent}>
          <List style="terms">
            ...
            <Item>11.3. OCI is only liable for direct damage.</Item>
            <Item>
